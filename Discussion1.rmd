...
It has a "recently added" category about 5 or 6 rows down, but it doesn't seem to be in really chronological order. I wish you could see the newest things on Netflix, that aren't personalized, because a lot of the times you get the same recommendations in this row as you do in the primary "recommended for you" row. 

I wish there was a way to switch between the user profiles within the account. The way it currently is, we're getting kids' shows along with more adult programming, clearly recommendations for multiple family members are side by side, more or less at random. I think there's a way to address who's watching in some other platforms (like Xbox or Apple TV app) but the mobile app doesn't have this to my knowledge. 

I feel like the 5 star rating system shouldn't be relied on too heavily because I don't think many people rate shows. And, like other 5 star rating systems like Amazon or Yelp, I suspect (though not sure) that there are more 1 and 5 star (extreme) ratings than "honest" star rating opinions. Either way, I don't think this 5 star rating system is very useful in the Netflix context is but I don't really know what the solution is to this, so maybe someone can give some input.
